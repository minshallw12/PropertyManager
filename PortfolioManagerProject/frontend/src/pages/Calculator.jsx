    ...
    return (
        <div className="calculator_page center">
            ...
            <div className="display">
                <div className="input_screen padding">
                    <div className="loan_amount">
                        <h3>Loan Amount</h3>
                        <input className="input" id="amount_input" placeholder="250,000"/>
                    </div>
                    <div className="loan_term">
                        <h3>Loan Term in Years</h3>
                        <input className="input" id="term_input" placeholder="30"/>
                    </div>
                    <div className="loan_rate">
                        <h3>Interest Rate</h3>
                        <input className="input" id="rate_input"placeholder="5"/>
                    </div>
                    <div className="loan_start">
                        <h3>Loan Start Date</h3>
                        <input className="input" id="date_input" type="date"/>
                    </div>
